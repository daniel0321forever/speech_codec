...
if __name__ == '__main__':
    ...
    pipeline = PM_QUANTIZED(
        model=model,
        weight_dir="models/quantized_revisit",
        log_dir = "logger/quantized_revisit",
    )
    ...
    pipeline.generate(audio_path="raw_data_sample/test/wav48_silence_trimmed/p343/p343_004_mic1.flac", save_dir="performance/encodec_no_lstm")